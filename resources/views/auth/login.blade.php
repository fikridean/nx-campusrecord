...
<body class="bg-blue-900">
    <div class="flex min-h-screen p-5 md:p-0">
        <!-- Login Form -->
        <div
            class="flex flex-col justify-center items-center w-full md:w-1/2 bg-white p-4 md:p-8 max-md:border rounded-2xl shadow-md md:rounded-none">
            ...
            <div class="w-full p-10">
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Don’ts have an account? <a href="{{ route('register') }}"
                        class="font-medium text-blue-600 hover:text-blue-500">Sign
                        up here</a>
                </p>
            </div>
        </div>
